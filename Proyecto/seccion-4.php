...
$sql = " SELECT * FROM publicacionesp WHERE id ='4'";
...
<div class=" col-md-9">
<div>
<div class="adm1">Descripción<hr class="DaD">
</div><br>
...
<div class="info">
		 <textarea class="cuadro2" name="detalle" placeholder="Descripción:" required>
		 <?php 
...
<div class="Galeria">
<p>•Primer imagen:</p><hr><input type="file" name="archivo" value="<?php echo $row["foto_4"]; ?>" ><br>
<br>
<p>•Segunda imagen:</p><hr><input type="file" name="archivo" value="<?php echo $row["foto_5"]; ?>" ><br>
